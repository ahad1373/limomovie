                               ...
                               @csrf
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="video_id" type="number" placeholder="شماره تصادفی فیلم" id="contactinput5">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactinput5">نام فارسی فیلم</label>
                                        <input class="form-control border-primary" name="persian_title" type="text" placeholder="نام فارسی فیلم" id="contactinput5">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactinput5">نام اصلی(انگلیسی) فیلم</label>
                                        <input class="form-control border-primary" name="original_title" type="text" placeholder="نام اوریجینال فیلم" id="contactinput5">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control border-primary" name="director" type="text" placeholder="سازندگان فیلم" id="contactinput5">
                                    </div>

                                    <div class="form-group">
                                        <label for="contactinput5"> نویسندگان فیلم </label>
                                        <input class="form-control border-primary" name="writer" type="text" placeholder="نویسندگان فیلم" id="contactinput5">
                                    </div>
