@component('Admin.layouts.content',['title' => 'اضافه کردن بازیگران فیلم'])
    @slot('breadcrumb')
        <li class="breadcrumb-item active">اضافه کردن بازیگران فیلم </li>
                ...
                return `
                    ...
                    <div class="col-5">
                            <div class="form-group">
                                 ...
                                 <input type="text" name="actors[${id}][actor_title]"  class="form-control">
                            </div>
                        </div>
                                                       <input type="hidden" name="actors[${id}][video_id]" value="{{$video_id}}"  class="form-control">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('admin.film-actor-store' , $video->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
